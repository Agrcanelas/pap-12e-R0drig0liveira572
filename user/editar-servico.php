    ...
    if ($nome === '') {
      ...
      if ($stmt) {
        ...
        if ($stmt->execute()) {
          ...
          $message = 'Erro ao atualizar serviço: ' . $stmt->error;
          $message_type = 'error';
        }
        $stmt->close();
      } else {
...
<head>
  <title>Editar Serviço | Banco do Tempo</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Editar Serviço</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card tbl-card">
            <div class="card-body">
                ...
                ?>
                  ...
                  <input type="text" class="form-control" name="descricao" id="descricao" value="<?php echo htmlspecialchars($current_descricao); ?>" required=""><br>
                  ...
                  <select class="form-control" name="categoria" id="categoria" required="">
                    ...
                    if ($result_cat->num_rows > 0) {
                      while ($row_cat = $result_cat->fetch_assoc()) {
                        $sel = ($row_cat['id_categoria'] == $current_categoria) ? ' selected' : '';
                        echo "<option value='" . htmlspecialchars($row_cat['id_categoria']) . "'" . $sel . ">" . htmlspecialchars($row_cat['nome']) . "</option>";
                      }
                    }
                    ?>
                  </select><br>
